...
//
//      import SVMModel.Config.default._
//      import SVMModel._
//
//      val fSeed = {
//        val name = "Seed"
...
//
//    def negatum  (implicit tx: S#Tx): SVMModel[S]            = modelH()
...
//              )
//              val cPenalty  = SVMModel.Penalty()
//              val config    = SVMModel.Config(seed = seed, generation = cGen, breeding = cBreed, evaluation = cEval,
//                penalty = cPenalty)
//
...
//                case SVMModel.Rendering.Success => finished()
//                case SVMModel.Rendering.Failure(SVMModel.Rendering.Cancelled()) => finished()
